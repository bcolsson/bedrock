...
data-preferences-your-privacy-v2 = Your privacy is very important to { -brand-name-mozilla }. Our first-party telemetry and analytics systems, such as <a href="{ $glean }">{ -brand-name-glean }</a>, follow our own high standards for <a href="{ $lean_data }">lean data practices</a>.
