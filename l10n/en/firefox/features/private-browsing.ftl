...
features-private-browsing-compare-firefoxs-private-browsing = Compare { -brand-name-firefox }’s private browsing with <a href="{ $chrome }">{ -brand-name-chrome }’s incognito mode</a>.
